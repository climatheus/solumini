...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('contract.update', $contract) }}" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="company_owner"
                            name="company_owner"
                            value="{{ old('company_owner') ? old('company_owner') : $contract->company_owner }}"
                        >
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="seller_name"
                            name="seller_name"
                            value="{{ old('seller_name') ? old('seller_name') : $contract->seller_name }}"
                        >
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            @forelse ($companies as $company)
                                <option
                                    {{ (old('company_id') == $company->id || $contract->company->id == $company->id) ? 'selected' : '' }}
                                    value="{{ $company->id }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="expire_date"
                            name="expire_date"
                            value="{{ old('expire_date') ? old('expire_date') : $contract->expire_date->format('Y-m-d') }}">
            ...
            <button class="btn btn-sm btn-success mt-3 mb-5">Salvar</button>
        </form>
    </div>
@endsection
